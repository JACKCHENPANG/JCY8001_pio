...
main.c Flash 3916B, 零警告。**dev 固件 Modbus 协议层基本完整**: FC01/02/03/04/05/06/0F/10 + 温度/电压/阻抗/均衡/参数/群发/多通道/ZM模式。剩余真实电芯待验证项: 阻抗 RE/IM 数值、均衡放电效果、balVolt 换算系数标定、低阻模式实际降噪效果。
